    ...
    <div class="container1">
        <div class="container2">
            ...
            <div class="table1">
                ...
                <form class="row g-3" action="6.4.3)teacherAssignmentsDelete.php" method="post">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <label for="USN" class="">Assignment 1 : </label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="USN" placeholder="Assignment 1" name="asm1" value=<?php echo $row['asm1'] ?> required>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <label for="USN" class="">Assignment 2 : </label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="USN" placeholder="Assignment 2" name="asm2" value=<?php echo $row['asm2'] ?> required>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <label for="USN" class="">Assignment 3 : </label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="USN" placeholder="Assignment 2" name="asm3" value=<?php echo $row['asm3'] ?> required>
                        </div>
                    </div>
